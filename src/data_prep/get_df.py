...
def get_abbriviated_names(player_name):
    ...
    if player_name == "Zion Williamson":
        print("Zion Williamson found, replacing with abbreviated name")
...
def get_df(allstar_fp, college_fp, nba_stats_fp, draft_fp, start_year, end_year):
    ...
    nba_stats = get_nba_player_impact_data(nba_stats_fp, start_year, end_year+1)
